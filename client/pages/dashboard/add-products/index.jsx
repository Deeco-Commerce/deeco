      ...
      <main className="flex items-center justify-center flex-col">
        <div className="w-full">
          ...
          <div className="bg-white p-4 md:p-8 w-full pb-[8rem]">
            <h2 className="text-2xl font-bold pt-8">Product Details</h2>
            <div>
              <div className="mt-8">
                <h1 className="text-xl font-normal">Images</h1>
              ...
              <div className="flex flex-col w-full md:w-[45%] mt-8">
                <label className="text-xl font-medium pb-1">Product Name</label>
                <input
                  type="text"
              ...
              <div className="flex flex-col mt-8 w-full md:w-[35%]">
                <label className="text-xl font-medium pb-1">Price (NGN)</label>
                <input
                  type="text"
                  placeholder="Enter your username"
                  className=" outline-none p-4 rounded-sm border border-[#E0E0E0]"
              ...
              <div className="flex flex-col mt-8 w-full">
                <label className="text-xl font-medium pb-1">Product Description</label>
                <ReactQuill
                  theme="snow"
              ...
              <div className="mt-[6rem] md:mt-20 mb-20">
                <h1 className="text-xl font-normal">Description Images</h1>
                <p className="text-[#C2C2C2] font-normal text-sm py-3">
